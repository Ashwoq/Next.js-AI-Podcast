          ...
          <div className="flex flex-col gap-[30px] border-b border-black-5 pb-10">
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <Select onValueChange={(value) => setVoiceType(value)}>
                ...
                <SelectContent
                  className="
                text-16 border-none bg-black-1 font-bold text-white-1 focus:ring-offset-orange-1 
                  "
                >
                  {voiceCategory.map((category) => (
                    <SelectItem
                      key={category}
                      value={category}
                      className="capitalizez focus:bg-orange-1"
                    >
                      {category}
                    </SelectItem>
                  ))}
                ...
                <FormItem className="flex flex-col gap-2.5">
                  ...
                  <FormControl>
                    <Textarea
                      className="
                      input-class focus-visible:ring-offset-orange-1"
                      placeholder="Write a podcast description in short..."
                      {...field}
                    />
                  </FormControl>
